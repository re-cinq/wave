...
```bash
tea issues comment <EPIC_NUMBER> --repo <OWNER/REPO> --body "$(cat <<'COMMENT'
## Implementation Summary

**Pipeline**: gt-implement-epic
  ...
  "results": [
    {
      ...
      "status": "implemented",
      "pr_url": "https://gitea.example.com/re-cinq/wave/pull/250",
      "pr_number": 250
    }
  ],
  "summary": {
    ...
    "skipped": 1,
    "comment_posted": true,
    "comment_url": "https://gitea.example.com/re-cinq/wave/issues/184#issuecomment-12345"
  }
}
```
