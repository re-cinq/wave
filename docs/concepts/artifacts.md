...
The artifact is copied into the step's workspace at `.agents/artifacts/context`.
...
analyze   report        json    .agents/workspaces/.../.agents/output/report.json
```
