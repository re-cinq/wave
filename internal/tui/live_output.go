...
// Thin wrapper that delegates to the canonical display.EventLine formatter
// using the live-TUI profile. The canonical implementation lives in
// internal/display/eventline.go.
